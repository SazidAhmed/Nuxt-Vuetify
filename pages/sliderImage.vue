    ...
    export default {
        ...
        return {
            ...
            headers: [
                ...
                { text: 'TagLine', align: 'start', sortable: true, value: 'tagline'},
                { text: 'DisplaySection', align: 'start', sortable: true, value: 'displaysection'},
